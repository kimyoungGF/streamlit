...
image_files = [
    'https://github.com/kimyoungGF/streamlit/blob/main/sidebar/data/Vermeer.png?raw=true', 
    'https://github.com/kimyoungGF/streamlit/blob/main/sidebar/data/Gogh.png?raw=true', 
    'https://github.com/kimyoungGF/streamlit/blob/main/sidebar/data/Munch.png?raw=true', 
    'https://github.com/kimyoungGF/streamlit/blob/main/sidebar/data/ShinYoonbok.png?raw=true'
    ]
